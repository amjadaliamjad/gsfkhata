...
if (uiJs.includes(option1Start)) {
    ...
    <br><hr style="border:none;border-top:2px dashed var(--g300);margin:30px 0;"><br>`);
        ...
        let closingPointStr = "export function renderIslamicWarning";
        let targetIdx = uiJs.indexOf(closingPointStr);
        if (targetIdx !== -1) {
            ...
            if (lastClosingIdx !== -1) {
                ...
                console.log("Successfully added dashboard toggle logic and fixed syntax");
            }
        }
    }
}
